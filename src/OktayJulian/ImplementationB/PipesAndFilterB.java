...
public class PipesAndFilterB {
    ...
    private static final String OUTPUT_PATH_1 = "src\\output1.txt";
    private static final String OUTPUT_PATH_2 = "src\\output2.txt";
    private static final int LINE_LENGTH = 80;
    private LineAlignment LINE_ALIGNMENT = LineAlignment.RIGHT;

    public static void main(String[] args) {
        Output output_1 = new Output(OUTPUT_PATH_1);
        LineToFileOutput output_2 = new LineToFileOutput(OUTPUT_PATH_2);
...
//        }
        ...
        CircularShiftFilter circularShiftFilter = new CircularShiftFilter((pmp.interfaces.Writeable<String[]>) pipe5_1, getFrequentWords(WORD_INPUT_PATH, NUMBER_OF_WORDS));
...
//        }
        ...
        LineAlignment LINE_ALIGNMENT=LineAlignment.CENTER;
//        if(args[6]!=null){
...
//        }
        ...
        try {
            input = new FileToCharacterInput(pipe1, INPUT_PATH);
